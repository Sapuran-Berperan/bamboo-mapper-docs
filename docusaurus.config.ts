...
const config: Config = {
  title: 'Sapuran Berperan',
  tagline: 'KKN-PPM UGM Periode IV 2025, Kec. Sapuran, Kab. Wonosobo, Jawa Tengah',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Sapuran Berperan',
      logo: {
        alt: 'Logo Sapuran Berperan',
        src: 'img/Logo Sapuran_transparent.png',
      },
      items: [
        {
          type: 'docSidebar',
